...
Connection conn=null;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Modifier un professeur ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1==null || jTextField2==null||jTextField3==null || jTextField4==null||jTextField5==null || jTextField6==null||jTextField7==null){
            ...
            try{
                ...
                pst=conn.prepareStatement("UPDATE `proffesseur` SET `nom`=?,`prenom`=?,`naissance`=?,`cni`=?,`numero de somme`=?,`affectation`=?,`volume d horaire`=?,`id matier`=?");
                ...
                rs=pst.executeQuery();
                if(rs.next()){
                    JOptionPane.showMessageDialog(null,"modifiement  en sucess !");
                }
